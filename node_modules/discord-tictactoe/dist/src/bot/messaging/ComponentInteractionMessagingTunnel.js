...
class ComponentInteractionMessagingTunnel extends MessagingTunnel_1.default {
    ...
    replyWith(answer, _direct) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._reply) {
                ...
                this._reply = (yield this.interaction.update(Object.assign(Object.assign({}, answer), { fetchReply: true })));
            }
            return this._reply;
        });
    }
    editReply(answer) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.editReply(reason !== null && reason !== void 0 ? reason : { content: '.', components: [], embeds: [] });
